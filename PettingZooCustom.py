...
class parallel_env(ParallelEnv):
	PLAYER_NUM = 4
	CARD_NUM = 7
	CARD_SUM = int((1 + CARD_NUM) * CARD_NUM / 2)
	...
	def __init__(self):
		...
		'''
		self.possible_agents = ["player_" + str(r) for r in range(self.PLAYER_NUM)]
		...
		self.observation_spaces = {agent: Discrete(
			4) for agent in self.possible_agents}
